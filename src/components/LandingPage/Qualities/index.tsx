...
const Qualities = (props: Props) => {
  ...
  return (
    <section className='px-[5rem] xxl:px-[10rem] py-[3rem] xxl:py-[6rem]' >
        <h2 className='font-bold text-[20] xxl:text-[27px] mb-11 xxl:mb-28'>دستان شما زندگی بخش است <hr className=' bg-gray-400 inline-block mr-4 m-1 h-[1px] xxl:w-[66px]' /></h2>
        <div className='flex justify-center gap-2 xxl:gap-6'>
            {cardsArray.map(card => <Card image={card.image} text_1={card.text_1} text_2={card.text_2}  />)}
        </div>
    </section>
  )
}
