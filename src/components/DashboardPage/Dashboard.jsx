...
const Dashboard = () => {
    ...
    useEffect ( () => {
        ...
        axios.get ( 'http://127.0.0.1:8000/charity/api/v1/ads/all_donators/' )
            .then ( res => {
                setTotalDonatores(res.data.count)
            } )
        axios.get('http://127.0.0.1:8000/charity/api/v1/ads/advertisement_count/')
            .then(response =>{
            ...
            <div>
                ...
                >
                    { generalInfo.map ( ( info ) => (
                        ...
                        >
                            <div
                                className=" absolute top-0 bottom-0 left-0 right-0 opacity-[50%] bg-[#212121] z-0"></div>
