...
const Navbar = (props: Props) => {
    const links = [{key:'home', value: 'خانه'}, {key:'about_us', value: ' درباره ما'},  {key:'pages', value: 'صفحات '}, {key:'web_texts', value: 'وب نوشت ها'}]
  return (
    <nav className={styles.navbar + ' px-16 xl:px-28 xxl:px-[17rem] top-8'}>
        <div className='flex w-full py-2   bg-white rounded-[71px] px-12 xl:px-17 xxl:px-[5rem] gap-5'>
            ...
            <div className={styles.right + ' gap-2'}>
                <div>
                    <img src={Search} alt="" className='w-[2rem] xl:w-[2.5rem] xxl:w-[3rem] h-[2rem] xl:h-[2.5rem] xxl:h-[3rem]'/>
                </div>
                <div className='flex gap-3'>
                    <div>
                        <img src={Profile} alt="profile pic" className='w-[30px] xl:w-[40px] xxl:w-[50px] h-[30px] xl:h-[40px] xxl:h-[50px]' />
                    </div>
