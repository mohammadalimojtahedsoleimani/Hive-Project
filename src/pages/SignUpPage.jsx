...
const SignUpPage = () => {
  ...
  const errorStyle =
    "text-[14px] xxl:text-[16px] text-red-500 flex flex-col content-start items-start mb-[0.9rem] xxl:mb-[1.5rem]";
  const inputStyle =
    "text-[#A3A3A3] bg-[#F3F2F2] rounded-lg text-[17px] xxl:text-[19px] p-[0.4rem] xxl:p-[0.9rem]";
  const inputMarginBottom = (error) => {
    if (!error) {
      return { marginBottom: "2.8vh" };
    }
    return {};
  };
  const form = () => {
    return (
      <form className="flex flex-col" onSubmit={submitHandler}>
        <input
          ...
          style={inputMarginBottom(errors.email && touch.email)}
        ...
        <input
          ...
          className={inputStyle}
          style={inputMarginBottom(errors.password && touch.password)}
          onChange={changeHandler}
          value={data.password}
          name="password"
          id="password"
        ...
        <input
          ...
          className={inputStyle}
          style={inputMarginBottom(errors.password1 && touch.password1)}
          onChange={changeHandler}
        ...
        {errors.password1 && touch.password1 && (
          <span className={errorStyle}>{errors.password1}</span>
        )}
  ...
  return (
    ...
    >
      <div className="right flex-1 flex justify-center items-center pl-[3.5rem] xxl:px-[5.5rem] pr-[5rem] xxl:pr-[8rem] min-h-[100vh]">
        <div className="right_parent pt-[4.5rem] relative bottom-8 xxl:bottom-16">
          ...
          <div className="grid grid-cols-3 font-[500] text-[15px] xxl:text-[18px] my-6 xxl:my-10 text-[#4D7AD2]">
      ...
      <div className="left flex-1 flex flex-col relative min-h-[100vh]">
        ...
        <div className="flex-[5] flex flex-col content-between px-9 xxl:px-11">
          <Link to="/">
            <div className="fixed flex cursor-pointer top-8 xxl:top-12 left-10 xxl:left-14">
