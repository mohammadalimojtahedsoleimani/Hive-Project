                ...
                <Row>
                        ...
                        <Row className={ styles.colmargin }>
                            <Col className={ styles.innerpadding }>
                                <div>
                                    ...
                                    <br></br>
                                    <p>یقینا قلب همه ما هنگامی که فرزندان این سرزمین را در سر چهار راه ها یا معابر در
                                        حال کار می بینیم، به درد می آید، کودکانی که باید بر سر بازی و تحصیل خود باشند تا
                                        آینده سازان این مرز و بوم بوده و ارزش آفرینی کنند
                                        هدف من جمع آوری مبلغی برای کمک به این کودکان و خرید مایحتاجشان در این شرایط بد
                                        اقتصادی است .....</p>
                                    <p>هدف من جمع آوری مبلغی برای کمک به این کودکان و خرید مایحتاجشان در این شرایط بد
                                        اقتصادی است...</p>
                                </div>
                                <div>
                                    <br></br>
                                    ...
                                    <br></br>
                                    <p>اینجانب علیرضامحمدی فعال مدنی در حوزه کودکان کار هستم هدف از این آگهی جمع آوری
                                        کمک هزینه ای برای کمک کار
                                        در شهرستان کرج بوده که همگی شاهد این هستیم که روزانه به تعداد این کودکان اضافه
                                        می شود</p>
                                </div>
                            </Col>
                        </Row>
                    ...
                    <Col className={ [ styles.margint ] } xl={ 3 } sm={ 12 } md={ 3 } lg={ 3 }>
                        ...
                        <div className={ styles.postcardslider }>
                            ...
                            <br></br>
                            <Row>
                                <Col xl={ 9 } sm={ 12 } md={ 9 } lg={ 9 }>کمک های مالی جمع شده</Col> <Col xl={ 2 }
                                                                                                          sm={ 12 }
                                                                                                          md={ 2 }
                                                                                                          lg={ 2 }>60%</Col>
                            </Row>
                            <Slider className={ styles.dir } defaultValue={ 50 } aria-label="Default"
                                    valueLabelDisplay="auto"/>
                            <Row className={ styles.smallfont }>
                                <Col xl={ 6 } sm={ 12 } md={ 6 } lg={ 6 }>جمع شده : 6 میلیون تومان</Col> <Col xl={ 6 }
                                                                                                              sm={ 12 }
                                                                                                              md={ 6 }
                                                                                                              lg={ 6 }>هدف
                                : 10 میلیون تومان</Col>
